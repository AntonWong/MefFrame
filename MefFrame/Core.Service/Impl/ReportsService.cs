...
namespace Core.Service.Impl
{
    ...
    public class ReportsService : CoreServiceBase, IReportsContract
    {
        ...
        {
            //ReportsRepository.DeleteEntity(new Reports{Id=id});
			return 0;
        }
        ...
        /// <returns></returns>
        public int Update(Expression<Func<Reports, object>> propertyExpression,Reports entity,bool isSave=false)
        {
            return ReportsRepository.UpdateEntity(propertyExpression, isSave, entity);
        }
